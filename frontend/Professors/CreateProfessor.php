...
<html>
    ...
    <body>
        <h1>ADMIN RECORD SYSTEM - CREATE PROFESSOR</h1>
        ...
        <?php
            if(isset($_POST['cancel'])){
                ...
                $professor = new Professor($nextAvailableID, $_POST['fname'], $_POST['lname']);
                $professor->subjects = $subjects;
                addNewPerson($professor->getLname(), $professor->getFname(), $professor->subjects, "Professor");
                header('location: ProfessorsMenu.php');
            }
        ?>
    </body>
